import 'package:classmate/library/src/easy_infinite_date_time/widgets/web_scroll_behavior.dart';
...
class _TimeLineWidgetState extends State<TimeLineWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveTimeLineBackgroundColor =
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final isSelected = EasyDateUtils.isSameDay(
                widget.focusedDate ?? initialDate,
                currentDate,
              );
  ...
  Widget _dayItemBuilder(BuildContext context, bool isSelected, DateTime date) {
