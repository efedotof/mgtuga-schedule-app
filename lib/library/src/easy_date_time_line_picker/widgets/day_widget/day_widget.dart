import 'package:classmate/library/src/easy_date_time_line_picker/utils/constants.dart';
...
class _DayWidgetState extends State<DayWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    T? resolve<T>(
      ...
      return effectiveValue((EasyThemeData? theme) {
    ...
    final BorderSide border =
        resolve<BorderSide?>(
          (theme) =>
              widget.isToday ? theme?.currentDayBorder : theme?.dayBorder,
          states,
        )!;
